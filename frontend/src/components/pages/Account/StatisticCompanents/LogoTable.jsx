  ...
  render() {
    ...
    for (let index = 0; index < arrVacancy.length; index++) {
      if (arrVacancy[index].vacancy.employer.logo_urls != null) {
        let indexLogo = logoArr.findIndex(item => item.companyId == arrVacancy[index].vacancy.employer.id);
        ...
        if (indexLogo != -1) {
          ...
          if (arrVacancy[index].vacancy.salary != null) {
            let to = arrVacancy[index].vacancy.salary.to;
            let from = arrVacancy[index].vacancy.salary.from;
